...
class GateNavigator:
    ...
    def update_drone_position(self, drone_position, threshold=0.1):
        """
        ...
        if self.previous_position is not None:
            ...
            # print ("distance_to_gate: ", distance_to_gate)
            ...
            if distance_to_gate < threshold and dot_product < self.dot_threshold:
...
class GatesRL(BaseAviary):
    ...
    def __init__(self,
        ...
        self.navigator = GateNavigator(self.gate_positions)
        self.GATE_IDS = []
        self.positions = []
    ...
    def _computeReward(self):
        ...
        euclidean_differ = self.previous_euclidean_dist - euclidean_dist
        orientation_differ = self.previous_orientation_dist - orientation_dist
        ...
        for gate in self.GATE_IDS:
            collision = p.getContactPoints(bodyA=self.DRONE_IDS[0],
                                bodyB=gate,
                                physicsClientId=self.CLIENT)
            if collision:
                reward = -5.0
        ...
        self.previous_orientation_dist = np.copy(orientation_dist)
        self.previous_euclidean_dist = np.copy(euclidean_dist)
    ...
    def reset(self,
        ...
        self.previous_euclidean_dist = 0
        self.previous_orientation_dist = 0
        self.navigator = GateNavigator(self.gate_positions)
    ...
    def _computeTerminated(self):
        ...
        if self._computeDroineFailed() or self.consecutive_stuck_steps >= self.stuck_threshold:
            return True
